...
\section{Změny specifikace}
		...
		\textit{findMosquitoInImage} o správnou detekci okrajů obrazovky a její kód byl
		optimalizován. Program byl změněn tak, aby sejmuté obrázky nevykresloval, 
		ale pouze je zaznamenával a tím se jeho běh zrychlil. Pro zpětné (\uv{offline}) vizuální 
		vyhodnocení úspěšnosti \uv{sestřelu} byla implemtována funkce \textit{playResults},
