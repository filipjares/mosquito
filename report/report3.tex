...
Experimenty poukázaly na dva problémy s tímto základní přístupem. 
Za prvé jsme došli k závěru, že pohyb komára je zatížen náhodným prvkem, který zhoršuje predikci pohybu.
